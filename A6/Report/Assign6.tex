...
%\problemAnswer{
 ...
 Using. following steps:
  \begin{enumerate}
  \item\textbf{} Assigned Variables , 'Age', 'Gender' and 'Occupation' as '23', 'M', 'Student' respectively.
  \item\textbf{} Selected the matching users \textbf{u.user} dataset, i received 6 such users.
  \item\textbf{} Selected 3 users with user ID's : \textbf{135, 33, 706}						      
 \end{enumerate}
%}
...
\begin{figure}[h]
  \centering
   \includegraphics[width=0.6\textwidth]{F1}
     \caption{Top 3 and Bottom 3 Favorite Movies}
	\end{figure}
...
I selected \textbf{33} as '\textbf{Substitute Me} and pass the preferences of the 'Substitute Me'
...
%\newpage
The above code will generate \textbf{corrlate.csv}, which gives the correlation of all the users in comparison with 'Substitute Me' i.e., user \textbf{33}

	
\begin{figure}[h]
  \centering
    \includegraphics[width=0.6\textwidth]{F2}
      \caption{Negative and Positive Correlation}
	\end{figure}
...
\begin{figure}[h]
  \centering
    \includegraphics[width=0.6\textwidth]{F3}
      \caption{Top 5 and Bottom 5 Recommended Movies}
	\end{figure}
...
%\problemAnswer{
 ...
 \textbf{transformPrefs} function was changed to get the preferences and to get the top 5 suggestions from the \textbf{topMatches} function.
The results for my favorite movie \textbf{The Shawshank Redemption} and my least favorite movie of that time \textbf{Jurassic Park} has been determined with positive and
negative correlations.
The following code has been rewrited and was originally taken from  \textbf{Programming Collective Intelligence}


		      
\begin{lstlisting}[language=Python, caption=Assignment6_4.py]
import csv
import math
import operator
import string
...
\begin{figure}[h]
  \centering
    \includegraphics[width=1.0\textwidth]{F4}
      \caption{Top and Bottom most and worst/least Favorite Recommendations respectively}
	\end{figure}
