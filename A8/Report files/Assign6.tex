...
\date{Tuesday, April 30, 2019} % Insert date here if you want it to appear below your name
...
%\problemAnswer{
 ...
 Steps that were taken are mentioned below.
  \begin{enumerate}
 	 \item\textbf{} I opened Spam folder and promotion folders for all of my emails 
  	\item\textbf{}  Created two different folders for Spam and not a Spam.
	 \item\textbf{} For each of the folder I added 20 email's data into them.
	 \item\textbf{} Finally I separated  them equally into testing and training dataset          	
...
\begin{figure}[h]
  \centering
    \includegraphics[width=0.6\textwidth]{output.png}
     \caption{Output stating Spam or Not a Spam}
	\end{figure}
%}
...
From my dataset I created a confusion matrix in which
each row of the matrix represents the instances in a predicted 
class(Spam or Not a Spam) while each column represents 
the instances in an actual class(Spam or Not a Spam).

\begin{figure}[h]
  \centering
    \includegraphics[width=0.6\textwidth]{confussionmatrix}
...
\item\textbf{} https://github.com/uolter/PCI
\end{enumerate}
\end{document}
